"""
Tune ML classifiers on vectorized BODMAS features with Optuna.

Examples:
    python backdoor_notebook/ml_training_bodmas/tune_ml_optuna.py ../bodmat/datasets backdoor_notebook/ml_training_bodmas/models/lgbm_bodmas.joblib --n-trials 30
    python backdoor_notebook/ml_training_bodmas/tune_ml_optuna.py ../bodmat/datasets /tmp/xgb_bodmas.joblib --algorithm xgboost --max-train-samples 20000 --study-path /tmp/xgb_bodmas.db
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.1,
        help="Fraction of the non-test split reserved for validation during tuning.",
    )
    parser.add_argument(
        "--test-fraction",
        type=float,
...
def main() -> None:
    ...
    study_kwargs: dict[str, Any] = {
        "direction": "maximize",
        "study_name": args.study_name or f"{algorithm}_{metric}_bodmas",
    }
