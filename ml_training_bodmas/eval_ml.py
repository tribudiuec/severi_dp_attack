"""
Evaluate saved ML artifacts on vectorized BODMAS features.

Examples:
    python backdoor_notebook/ml_training_bodmas/eval_ml.py ../bodmat/datasets backdoor_notebook/ml_training_bodmas/models/lgbm_bodmas.joblib
    python backdoor_notebook/ml_training_bodmas/eval_ml.py ../bodmat/datasets /tmp/lgbm_bodmas.joblib --subset test --max-eval-samples 20000
    python backdoor_notebook/ml_training_bodmas/eval_ml.py ../bodmat/datasets backdoor_notebook/ml_training_bodmas/models/lgbm_bodmas.txt --subset test
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Dataset subset to evaluate from the deterministic BODMAS split.",
    )
    parser.add_argument(
        "--validation-fraction",
        type=float,
        default=0.1,
        help="Fraction of the non-test split used when --subset validation.",
    )
    parser.add_argument(
        "--test-fraction",
        type=float,
